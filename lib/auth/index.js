...
function initialize(dbId, dbSecret, sandbox) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, firebase
                            ...
                            .auth()
                            .signInWithEmailAndPassword(dbId, dbSecret)["catch"](function (error) {
...
function getIdToken(sandbox) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, firebase.app(sandbox ? 'sandbox' : 'production').auth().currentUser.getIdToken()];
